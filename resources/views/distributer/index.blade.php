  ...
  <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title" style="text-transform: none !important;">Distributor</h6>
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $value)
                                    <tr role="row" class="odd">
                                        <td class=""><?= $SR_No++ ?></td>
                                        <td><a href="{{ url('detail/' . $value['_id']) }}">{{ $value['userName'] }}<i
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ url('distributer/edit/' . $value['_id']) }}" type="button"
