        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('transfercredits/' . $data['_id']) }}" id="form">
                        @csrf
                        <div class="form-group d-flex">
                            <div class="col-sm-3 offset-lg-3">
                                <h4 class="breadcrumb bg-light">User: {{ $data['userName'] }}</h4><br>
                                <h4 class="breadcrumb bg-light">Points: {{ number_format($data['creditPoint'], 2) }}</h4>
                            </div>
                            <div class="col-sm-3">
                                <h4 class="breadcrumb bg-light">Points available:
                                    {{ number_format(Session::get('creditPoint'), 2) }}</h4><br>
                            </div>
                        </div>
                        <div class="form-group d-flex">
                            <label class="col-sm-2 offset-lg-1 text-right control-label mt-2">Points Transfer</label>
                            <div class="col-sm-6">
                                <input type="number"
                        ...
                        <div class="form-group d-flex">
                            ...
                            <div class="col-sm-6">
                                <button type="submit" class="btn btn-primary delete-confirm">Points Transfer</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script type="text/javascript">
        $('#form').on('submit', function(event) {
            ...
            swalWithBootstrapButtons.fire({
                title: 'Are you sure?',
                text: "You Transfer to Amount : " + amount + "(" + convert(amount) + ")" +
