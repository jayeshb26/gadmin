...
class PhoneNumber extends \Faker\Provider\PhoneNumber
{
    ...
    public static function super_distributorRatePhoneNumber()
    {
        $number = static::numerify(static::randomElement(static::$specialFormats['super_distributor-rate']));
