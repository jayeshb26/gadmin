...
class PhoneNumber extends \Faker\Provider\PhoneNumber
{
    ...
    protected static $super_distributorPhoneNumber = array(
        '1900 ### ####'
    );
    ...
    public function super_distributorPhoneNumber()
    {
        return static::randomElement(static::$super_distributorPhoneNumber);
    }
